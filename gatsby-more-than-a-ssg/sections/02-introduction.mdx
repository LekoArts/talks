...
## Gatsby is a free and open source framework based on React to build websites & apps
...
<img
  style={{ marginTop: 'var(--t-m)', maxWidth: '100%' }}
  src={require('file-loader!../assets/gatsby-path.png')}
  alt="Google Lighthouse Score"
/>
...
<img
  style={{ marginTop: 'var(--t-m)', width: '800px' }}
  src={require('file-loader!../assets/gatsby-image.gif')}
  alt="Gatsby Image showing Lazy-Loading"
/>
