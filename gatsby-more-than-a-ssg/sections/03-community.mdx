...
<img
  ...
  src={require('file-loader!../assets/onboarding.jpg')}
  alt="Gatsby Bot Welcome Message"
/>
...
<Image
  ...
  src={require('file-loader!../assets/swag-store.jpg')}
/>
...
<Image
  style={{ backgroundSize: 'contain' }}
  src={require('file-loader!../assets/showcase.jpg')}
/>
...
<Image
  style={{ backgroundSize: 'contain' }}
  src={require('file-loader!../assets/starters.jpg')}
/>
...
<Image
  style={{ backgroundSize: 'contain' }}
  src={require('file-loader!../assets/plugins.jpg')}
/>
